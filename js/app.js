(() => {
    ...
    function initSliders() {
        if (document.querySelector(".advantages__slider")) new Swiper(".advantages__slider", {
            ...
            navigation: {
                prevEl: ".advantages__navigation .swiper-button-prev",
                nextEl: ".advantages__navigation .swiper-button-next"
            },
            breakpoints: {
                319.98: {
                    slidesPerView: 1.13,
        ...
        resizableSwiper("(max-width: 767.98px)", ".blog__slider", sliderSettings);
    }
    ...
    document.addEventListener("click", (e => {
        ...
        if (targetElement.closest(".languages__current")) targetElement.closest(".languages").classList.toggle("is-open");
        if (!targetElement.closest(".languages__current")) removeClasses(document.querySelectorAll(".languages.is-open"), "is-open");
    }));
    isWebp();
    menuInit();
    spollers();
